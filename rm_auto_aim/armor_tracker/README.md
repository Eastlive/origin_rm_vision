...
$$ x = [x_c, v_{xc}, y_c, v_{yc}, z_a, v_{za}, yaw, v_{yaw}, r] $$

观测的状态为
| 符号 | 含义 |
| --- | --- |
| $x_c$ | 机器人中心坐标的 x 分量 |
| $v_{xc}$ | 机器人中心坐标的 x 分量的速度 |
| $y_c$ | 机器人中心坐标的 y 分量 |
| $v_{yc}$ | 机器人中心坐标的 y 分量的速度 |
| $z_a$ | 装甲板中心坐标的 z 分量 |
| $v_{za}$ | 装甲板中心坐标的 z 分量的速度 |
| $yaw$ | 机器人的 Yaw 轴角度 |
| $v_{yaw}$ | 机器人的 Yaw 轴角速度 |
| $r$ | 装甲板中心坐标到机器人中心坐标的距离 |
